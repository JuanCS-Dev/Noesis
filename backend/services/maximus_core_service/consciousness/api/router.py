...
def create_consciousness_api(consciousness_system: dict[str, Any]) -> APIRouter:
    ...
    register_state_endpoints(router, consciousness_system, api_state)
    register_esgt_endpoints(router, consciousness_system, api_state)
    register_safety_endpoints(router, consciousness_system)
    register_reactive_endpoints(router, consciousness_system)
    register_streaming_endpoints(router, consciousness_system, api_state)
